    ...
    const fetchProducts = async () => {
      try {
        const response = await fetch(
          "/api/home/products?section=most-loved&limit=8"
        );
      ...
      <div className="container mx-auto mb-7 mt-12 sm:mt-24 lg:mt-28">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="poppins">
            <h1 className="font-semibold text-[28px] md:text-[32px] text-center lg:text-left">
              Most Loved Products Of This Week
            </h1>
            <div className="lg:max-w-2xl mt-3">
              <p className="text-[#333] opacity-80 text-base md:text-[17px] text-center lg:text-left font-medium">
                Loading products...
              </p>
            </div>
          </div>
    ...
    <div className="container mx-auto mb-7 mt-12 sm:mt-24 lg:mt-28">
      <div className="flex flex-col lg:flex-row items-center justify-between">
        <div className="poppins">
          ...
          <div className="lg:max-w-2xl mt-3">
            <p className="text-[#333] opacity-80 text-base md:text-[17px] text-center lg:text-left font-medium">
              Discover the favorites everyone’s talking about, with unbeatable
              quality and customer-loved performance.
            </p>
          </div>
        </div>
      ...
      <div className="mt-9 md:mt-12 flex items-center justify-center md:hiddenOur Best Sellers">
        <Link href={"/all-product"}>
          <ReusableButton
            variant="fill"
            className="px-8 py-4 text-sm font-semibold"
