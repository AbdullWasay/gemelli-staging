...
import { OrderListsTable } from "./OrderListsTable";
import Link from "next/link";
import Heading from "@/components/ui/Heading/Heading";

const OrderListComponent = () => {
  return (
    <div className="px-4 sm:px-0 max-w-full overflow-x-hidden flex flex-col min-h-[calc(100vh-220px)]">
      <Link
        href={"/dashboard/product-management"}
        className="flex items-center gap-2 mb-4 sm:mb-6 shrink-0"
      >
        <svg
        ...
        <Heading className="!mt-0 text-[#0F0F0F]">Order Lists</Heading>
      </Link>
