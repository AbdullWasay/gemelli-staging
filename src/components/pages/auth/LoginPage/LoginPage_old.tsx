...
const LoginPage_old = () => {
  ...
  const [selectedCard, setSelectedCard] = useState<"buyer" | "seller" | null>(
    null
  );
  ...
  const handleNavigation = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      router.push(selectedCard === "buyer" ? "/login-buyer" : "/login-seller");
    }, 200);
  };
        ...
        <div className="w-full max-w-xl space-y-6 md:space-y-8">
          ...
          <div className="">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 justify-items-center">
              {/* card 1 - Seller */}
              <div
                className={`w-full max-w-[270px] bg-[#F9F9F9] rounded-lg shadow-sm p-6 cursor-pointer transition-all ${
                  selectedCard === "seller"
              ...
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3
                    className={`font-semibold text-lg xl:text-xl mt-4 mb-[10px] ${
                      selectedCard === "seller" ? "text-primary" : "text-black"
                    }`}
                  >
                    Login as Seller
                  </h3>
                  ...
                  <p className="text-text-secondary text-sm">
                    Access your dashboard, track sales, and grow your business
                    with us.
                  </p>
                </div>
              </div>
              ...
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3
                    className={`font-semibold text-lg xl:text-xl mt-4 mb-[10px] ${
                      selectedCard === "buyer" ? "text-primary" : "text-black"
                    }`}
                  >
                    Login as Buyer
                  </h3>
                  ...
                  <p className="text-text-secondary text-sm">
                    Discover exclusive deals, save items to your wishlist, and
